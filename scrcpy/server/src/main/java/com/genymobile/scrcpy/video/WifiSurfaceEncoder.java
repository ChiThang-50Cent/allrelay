...
/**
 * Wi-Fi aware SurfaceEncoder that writes to WifiStreamer instead of Streamer.
 *
 * This class handles video capture and encoding for Wi-Fi transport.
 * It uses WifiStreamer which writes to an OutputStream (TCP socket)
 * rather than a FileDescriptor (ADB tunnel).
 */
public class WifiSurfaceEncoder implements AsyncProcessor {
    ...
    public WifiSurfaceEncoder(SurfaceCapture capture, WifiStreamer streamer, Options options) {
    ...
    private void encode(MediaCodec codec, WifiStreamer streamer) throws IOException {
    ...
    public void start(TerminationListener listener) {
        thread = new Thread(() -> {
            ...
            try {
                ...
                Ln.d("Wi-Fi screen streaming stopped");
